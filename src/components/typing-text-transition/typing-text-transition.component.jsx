...
import { TypingTextTransitionContainer } from "./typing-text-transition.styles";
import { TweenLite, Power1, Power2, Power3 } from "gsap/TweenLite";
...
const TypingTextTransition = () => (
  <TypingTextTransitionContainer>
    <p id="offscreen-text" class="offscreen-text" />
